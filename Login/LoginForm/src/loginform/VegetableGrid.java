...
public class VegetableGrid {
    ...
    public VegetableGrid() {
        ...
        vegetables = new String[]{
                "Peas", "Corn", "Kale", "Beet", "Yam", "Leek", "Okra", "Chard",
                "Radish", "Turnip", "Pumpkin", "Squash", "Garlic", "Onion",
                "Carrot", "Celery", "Cabbage", "Lettuce", "Chili", "Spinach",
                "Fennel", "Broccoli", "Rutabaga", "Parsley", "Zucchini",
                "Eggplant", "Artichoke", "Chives", "Arugula", "Nopales",
                "Seaweed", "Daikon", "Mushroom", "Bamboo",
                "Celeriac", "Bitter", "Asparagus", "Chicory", "Chayote",
                "Snap pea", "Chervil", "Kohlrabi", "Watercress", "Swiss",
                "Endive", "Horseradish", "Kale", "Cabbage", "Carob"
        };
    ...
    private void createAndShowGUI() {
        ...
        JPanel backgroundPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon backgroundImage = new ImageIcon("G:\\WordWizz project\\2.png"); // Set your vegetable background image path
