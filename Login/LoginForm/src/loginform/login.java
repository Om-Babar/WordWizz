...
public class login extends javax.swing.JFrame {
    ...
    public login() {
        ...
        adminCredentials.put("admin4", "password4");
        adminCredentials.put("admin5", "password5");
        adminCredentials.put("admin6", "password6");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Downloads\\W (2).png")); // NOI18N
  ...
  String username = txtusername.getText();  
    ...
    if (validateLogin(username, password)) {
        ...
        // Initialize and show the WordWizzGUI after login
        WordWizzGUI wordWizzGUI = new WordWizzGUI();
        wordWizzGUI.setVisible(true); // Make the WordWizz window visible
        wordWizzGUI.setSize(600, 600); // Set size to fit the GUI components
        wordWizzGUI.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
