...
public class AnimalGrid {
    ...
    public AnimalGrid() {
        ...
        animals = new String[]{
                "Dog", "Cat", "Cow", "Fox", "Bat", "Ant", "Rat", "Pig", "Owl", "Bee",
                "Yak", "Eel", "Hare", "Deer", "Lynx", "Crow", "Seal", "Wolf", "Dove",
                "Lamb", "Frog", "Newt", "Crab", "Mole", "Hawk", "Lark", "Shrew",
                "Puma", "Tuna", "Eagle", "Gull", "Finch", "Emu", "Mynah", "Llama",
                "Bison", "Otter", "Hyena", "Panda", "Koala", "Sloth", "Bunny",
                "Tiger", "Fox", "Moose", "Lynx", "Koi", "Shark", "Pike", "Ostrich",
                "Chinchilla", "Wombat", "Dingo", "Bunny", "Pelican", "Otter",
                "Gazelle", "Coyote", "Ferret", "Mantis", "Cockatoo", "Parrot",
                "Chipmunk", "Chinchilla", "Pika", "Raven", "Stingray", "Aardvark"
        };
    ...
    private void createAndShowGUI() {
        ...
        JPanel backgroundPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon backgroundImage = new ImageIcon("G:\\WordWizz project\\1.png"); // Set your background image path
